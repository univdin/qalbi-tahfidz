...
export const SITE_DESCRIPTION =
  "Web app (PWA) hafalan Al-Qur'an: murottal per ayat, mushaf dwi-skrip Uthmani/IndoPak, penjadwalan ulangan FSRS, modul khusus Metode Ummi (Murottal Anak Juz 30, Nada Nahawand), dan dashboard pantauan untuk orang tua & guru.";
